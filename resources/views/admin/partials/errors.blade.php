@if ($errors->any())
    <div class="rounded-2xl bg-white dark:bg-gray-800 border border-red-200 dark:border-red-900/50 p-5 mb-8 shadow-xl shadow-red-500/10"
         x-data="{ show: true }"
         x-show="show"
        ...
        <div class="flex gap-4">
            ...
            <div class="flex-1 min-w-0">
                <h3 class="text-lg font-semibold text-red-800 dark:text-red-200">
                    {{ count($errors) }} خطا در اعتبارسنجی
                </h3>
