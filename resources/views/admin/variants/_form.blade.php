<div class="grid md:grid-cols-2 gap-6">
    ...
    @if ($variantAttribute?->attribute?->name)
        ...
        <div>
            ...
            <select name="attribute_value" class="w-full rounded-xl border-slate-200 bg-slate-50">
...
<div class="grid md:grid-cols-2 gap-6">
    ...
    <div>
        ...
        <input type="number" step="0.01" name="price" value="{{ old('price', $variant->price ?? 0) }}"
            class="w-full rounded-xl border-slate-200 bg-slate-50">
...
@if ($variantAttribute)
    ...
    <div class="mt-6">
        ...
        <x-image-uploader name="images[]" label="Variant Images" />
